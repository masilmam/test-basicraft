  ...
  <form action="<?= base_url('Welcome/doEditRent'); ?>" method="POST">
    ...
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
        ...
        <div class="input-group mb-3">
          <select name="id_member" id="id_member" class="form-control custom-selcet">
        ...
        <div class="input-group mb-3">
          <input type="date" class="form-control" name="date_out" id="date_out" aria-describedby="basic-addon3" value="<?= $bookRent->date_out; ?>">
        </div>
